...
2. Simulate 100 random samples from a standard normal distribution <span id="dots">...</span><span id="more">using the function rnorm(). Store these 100 values in a vector called x. Then, compute the empirical median, mean and variance of x. Are these results different from 0, 0 and 1 (their respective theoretical values)? Is this result surprising? Justify your answer.</span>
